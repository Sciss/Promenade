...
//      set += d
  ...
  def neg_9905128(): Unit = {
    ...
    val protect_1         = Protect(min_14, 0.0, inf, false)
    ...
    val freq_14           = Protect(min_14, -inf, inf, false)
    ...
    val mix               = Mix(
      Seq[GE](min_5, ring4, lFPar_0, min_47, integrator_0, min_68, quadC, gbmanL, lag, fold2, min_108,
        pitchShift_1, latoocarfianC_1, min_121, min_124, min_126, lFGauss, roundTo, lag2UD, decay2,
        min_127, lt_1, bRZ2, min_133, min_135))
    NegatumOut(mix)
  }
}
